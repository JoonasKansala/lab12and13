...
def queues_create():
	...
	curl -X POST -H 'Content-Type: application/json' http://localhost:5000/queues -d '{"name": "D15123170_Lab12"}'
	curl -X POST -H 'Content-Type: application/json' 52.18.184.96:8080/queues -d '{"name": "D15123170_Lab12"}'
...
def queues_remove(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queues/D15123170_Lab12
	curl -X DELETE -H 'Accept: application/json' 52.18.184.96:8080/queues/D15123170_Lab12
...
def messages_count(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/D15123170_Lab12/msgs/count
	curl -X GET -H 'Accept: application/json' 52.18.184.96:8080/queues/D15123170_Lab12/msgs/count
	"""
...
def messages_write(name):
	...
	curl -s -X POST -H 'Accept: application/json' http://localhost:5000/queues/D15123170_Lab12/msgs -d '{"content": "this is the message I want to put on the queue"}' 
	curl -s -X POST -H 'Accept: application/json' 52.18.184.96:8080/queues/D15123170_Lab12/msgs -d '{"content": "this is the message I want to put on the queue"}'
	"""
...
def messages_read(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/D15123170_Lab12/msgs
	curl -X GET -H 'Accept: application/json' 52.18.184.96:8080/queues/D15123170_Lab12/msgs
	"""
...
def messages_consume(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queues/D15123170_Lab12/msgs
	curl -X DELETE -H 'Accept: application/json' 52.18.184.96:8080/queues/D15123170_Lab12/msgs
	"""
